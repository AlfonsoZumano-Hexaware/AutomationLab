...
public class Test_4_Incorrect_Data {
	
	WebDriver driver = null;
	ExtentSparkReporter htmlreporter = new ExtentSparkReporter("Test_4_Report.html");
	...
	@Test
	public void IncorrectDataTest() throws IOException {		
		...
		userTest = extent.createTest("Incorrect data", "Validation of error messages when entering incorrect data for user registration");
		...
		loginPage.enterPersonalInfo(sheet.readData("name"), sheet.readData("invalidName"), sheet.readData("pass"), sheet.readData("bday"), sheet.readData("bmonth"), sheet.readData("byear"));
		...
		loginPage.ValidateInvalidDataMessages();
